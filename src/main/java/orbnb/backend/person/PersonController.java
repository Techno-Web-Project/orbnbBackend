...
public class PersonController {
    ...
    public void assignMessageToPerson(@PathVariable("messageId") Long messageId, @PathVariable("personId") Long personId) {
        this.messageService.assignMessageSendToPerson(messageId, personId);
    }

    @PutMapping("/assignMessageReceivedToPerson/{messageId}/{personId}")
    public void assignMessageReceivedToPerson(@PathVariable("messageId") Long messageId, @PathVariable("personId") Long personId) {
        this.messageService.assignMessageReceivedToPerson(messageId, personId);
    }


    @PutMapping("/assignBookingToPerson/{bookingId}/{personId}")
